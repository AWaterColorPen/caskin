...
func TestServer_Policy_GetPolicyList(t *testing.T) {
	...
	//}
	//assert.NoError(t, service.PolicyPerRoleModify(roles[0], policy1))
	//
	//list3, err := service.PolicyGet()
	//assert.NoError(t, err)
...
func TestServer_Policy_ModifyPolicyListPerRole(t *testing.T) {
	...
	//}
	//assert.Equal(t, caskin.ErrNoWritePermission, service.PolicyPerRoleModify(roles0[0], policy1))
	//
	...
	//}
	//assert.NoError(t, service.PolicyPerRoleModify(roles1[0], policy2))
	//list1, err := service.PolicyGet()
	//assert.NoError(t, err)
	...
	//	{roles1[0], objects0[0], stage.Domain, caskin.Write},
	//}
	//assert.Equal(t, caskin.ErrInputPolicyListNotBelongSameRole, service.PolicyPerRoleModify(roles1[0], policy3))
}
