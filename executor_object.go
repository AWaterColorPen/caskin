...
func (e *server) ObjectCreate(user User, domain Domain, object Object) error {
...
// 3. set object to parent's g2 in the domain
func (e *server) ObjectRecover(user User, domain Domain, object Object) error {
...
func (e *server) ObjectDelete(user User, domain Domain, object Object) error {
...
func (e *server) ObjectUpdate(user User, domain Domain, object Object) error {
...
func (e *server) ObjectGet(user User, domain Domain, action Action, ty ...ObjectType) ([]Object, error) {
